...
class Barang_masuk extends CI_Controller {
	...
	{	
		...
		$data['content'] = 'admin/stockphile/v_barang_masuk';
	...
	{	
		...
		$data['content'] = 'admin/stockphile/barang_masuk';
		$this->load->view('admin/dashboard', $data);
	...
	{	
		...
		$data['content'] = 'admin/stockphile/tampil_gambar_masuk';
		$this->load->view('admin/dashboard', $data);
	...
	function upload_image(){
        ...
        if ( ! $this->upload->do_upload("gambar")){
			...
			redirect('index.php/admin/stockphile/barang_masuk');
		}
