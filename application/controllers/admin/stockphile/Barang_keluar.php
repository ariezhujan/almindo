...
class Barang_keluar extends CI_Controller {
	...
	{	
		...
		$data['content'] = 'admin/stockphile/v_barang_keluar';
	...
	{	
		...
		$data['content'] = 'admin/stockphile/barang_keluar';
		$this->load->view('admin/dashboard', $data);
	...
	{	
		...
		$data['content'] = 'admin/stockphile/tampil_gambar_keluar';
		$this->load->view('admin/dashboard', $data);
	...
	function upload_image(){
        ...
        if ( ! $this->upload->do_upload("gambar")){
			...
			redirect('index.php/admin/stockphile/barang_keluar');
		}
