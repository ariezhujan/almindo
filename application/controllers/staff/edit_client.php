<div id="order">
<a href="<?php echo base_url() ?>admin/member_view" class="close-order" title="Close"><i class="material-icons">cancel</i></a>
...
<div class="col-md-3"></div>
			 <div class="col-md-6" style="margin-top:-40px">
              <div class="card">
                ...
                <div class="card-body">
				<form action="<?php echo site_url() ?>index.php/admin/member_view/save?id=<?php echo $this->input->get('id') ?>" method="post">
