             ...
             <div id="accept">
              <div class="window">
                <a href="<?php echo base_url() ?>admin/prospective_member_view" class="close-button" title="Close">&times;</a>
                  <form class="card-member-register" role="form" action="<?php echo base_url() ?>admin/member_add/save?id=<?php echo $this->input->get('id') ?>&email=<?php echo $this->input->get('email') ?>" method="post" class="register-form" id="register-form">
