...
?>
<a href="<?php echo base_url() ?>admin/order/order_client_progress?id=<?php echo $id ?>&company_name=<?php echo $company_name ?>&po=<?php echo $po ?>&calories=<?php echo $calories ?>&size=<?php echo $size ?>" class="close-order" title="Close"><i class="material-icons">cancel</i></a><
...
<div class="row">
  ...
  <div class="col-sm-12 col-md-4 col-lg-4">
    <div class="card">
      <div class="card-body">
<form action="<?php echo site_url() ?>admin/order/order_client_progress/update_progress?id=<?php echo $id ?>&company_name=<?php echo $company_name ?>&po=<?php echo $po ?>&calories=<?php echo $calories ?>&size=<?php echo $size ?>" method="post">
