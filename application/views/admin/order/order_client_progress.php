...
<a href="<?php echo base_url() ?>admin/order/order_client/index1?id=<?php echo $su->id ?>&po=<?php echo $su->po ?>&size=<?php echo $su->size ?>&calories=<?php echo $su->calories ?>" class="close-order" title="Close"><i class="material-icons">cancel</i></a>
<?php } ?>
     <div class="windoworder">
		  ...
		  <div class="card">
			...
			<a href="<?php echo base_url() ?>admin/order/order_client_progress/set_progress?no=<?php echo $su->no_order ?>&id=<?php echo $su->id ?>&po=<?php echo $su->po ?>&status=<?php echo $su->delivery_status ?>&company_name=<?php echo $su->company_name ?>&calories=<?php echo $su->calories ?>&size=<?php echo $su->size ?>" class="btn btn-primary">Change Status Delivery</a>
			</div>
            </div>
		   <?php ;} ?>
