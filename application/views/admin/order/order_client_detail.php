...
?>
<a href="<?php echo base_url() ?>admin/order/order_client" class="close-order" title="Close"><i class="material-icons">cancel</i></a>
...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
			  ...
			  <a href="<?php echo base_url() ?>admin/order/order_client_progress?id=<?php echo $su->id ?>&po=<?php echo $su->po ?>&calories=<?php echo $su->calories ?>&size=<?php echo $su->size ?>" class="btn btn-primary">DELIVERY DETAIL</a>
