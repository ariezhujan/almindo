...
?>
<a href="<?php echo base_url() ?>admin/pricing/charcoalpricing?id=<?php echo $id; ?>&company_name=<?php echo $company_name; ?>" class="close-order" title="Close"><i class="material-icons">cancel</i></a>
                ...
                <div class="card-body">
                    <div class="row">
                      <div class="col-md-12">
						...
						<form method="post" action="<?php echo base_url() ?>admin/pricing/charcoalpricing/update?id=<?php echo $this->input->get('id'); ?>&company_name=<?php echo $company_name = $this->input->get('company_name')?>">
							...
							<div class="col-lg-3 col-md-3 col-sm-12">
								<p><input class="uang" class="form-control" type="text" name="pricing" placeholder="<?php echo $this->input->get('pricing'); ?>" required="required"></p>
							</div>
