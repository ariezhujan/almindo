                    ...
                    <table id="example" class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr style="word-wrap: break-word">
                          ...
                          <td>
                            <a href="<?php echo site_url() ?>admin/pricing/charcoalpricing/index_price?id=<?php echo $su->id ?>&company_name=<?php echo $su->company_name ?>" class="btn btn-sm btn-primary"><i class="fa fa-cog fa-lg text-default"></i>&nbsp;Set Pricing</a>
