                ...
                <div class="card-body">
                    <div class="row">
                      <div class="col-md-12">
						...
						<form method="post" action="<?php echo base_url() ?>admin/pricing/charcoalpricing/save?id=<?php echo $this->input->get('id'); ?>&company_name=<?php echo$company_name = $this->input->get('company_name')?>">
							<div class="inc">
						<div class="controls">
						<div class="row" class="remove_this">
								...
								<div class="col-lg-2 col-md-2 col-sm-12">
									<input type="text" class="uang" type="width:10px" class="form-control" name="pricing[]" placeholder="Pricing(Rp)" required="required">
								</div>
								<div class="col-lg-2 col-md-2 col-sm-12">
