...
?>
<a href="<?php echo base_url() ?>admin/payment/payment_client" class="close-order" title="Close"><i class="material-icons">cancel</i></a>
...
<div class="row">
  ...
  <div class="col-sm-12 col-md-4 col-lg-4">
    <div class="card">
      <div class="card-body">
		<form action="<?php echo site_url() ?>admin/payment/payment_client/payment_update" method="post">
