                    ...
                    <table id="example" class="table table-hover" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr style="word-wrap: break-word">
						  ...
						  <td>
						   <a href="<?php echo base_url() ?>admin/receivable/receivable/detail_receivable?id=<?php echo $su->id ?>&company_name=<?php echo $su->company_name ?>" class="btn btn-primary" data-toggle="tooltip" title="Input Data"><i class="fa fa-pencil fa-lg text-default"></i>&nbsp;Input Data</a>
						  </td>
                        </tr>
                        <?php ; } ?>
                      </tbody>
