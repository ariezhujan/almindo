             ...
             <div id="accept">
              <div class="window">
                <a href="<?php echo site_url() ?>staff/Request_client_baru" class="close-button" title="Close">&times;</a>
                  <form class="card-member-register" role="form" action="<?php echo base_url() ?>staff/member_add/save?id=<?php echo $this->input->get('id') ?>&email=<?php echo $this->input->get('email') ?>" method="post" class="register-form" id="register-form">
                      ...
                      <table class="tab-member-register">
                        <thead>
                              <th>Silahkan membuat Password untuk member <?php echo $this->input->get('company_name') ?></th>
                        </thead>
                        <tbody>
                          <tr>
                            <td>
