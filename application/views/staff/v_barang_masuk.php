            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Stock Pile Barang Masuk</h4>
                  <?php echo $this->session->flashdata('notif') ?>
                  <p class="card-category"></p>
                </div>
                <div class="card-body">
                    <table id="example" class="table table-hover">
					<a href="<?php echo site_url() ?>staff/barang_masuk/index1" class="btn btn-sm btn-primary"><i class="fa fa-plus-square fa-lg text-default"></i>&nbsp;&nbsp;Input Data</a>
					  ...
					  <?php 
                        ...
                        <tr style="word-wrap: break-word">
                          ...
                          <td><?php echo $su->surat_jalan ?>&nbsp;&nbsp;<a href="<?php echo site_url() ?>staff/barang_masuk/tampil_gambar?po=<?php echo $su->po ?>&nama=<?php echo $su->surat_jalan ?>" title="Lihat"><i class="fa fa-images fa-lg text-primary"></i>&nbsp;&nbsp;</a></td>
