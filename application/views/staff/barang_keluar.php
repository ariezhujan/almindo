...
?>
<a href="<?php echo base_url() ?>staff/barang_keluar/index" class="close-order" title="Close"><i class="material-icons">cancel</i></a>
              ...
              <div class="card">
                <div class="card-header card-header-tabs card-header-primary">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <span class="nav-tabs-title"><h4>Input Barang Keluar</span>
                    </div>
                  </div>
                </div>
				<br>
                ...
                <div class="card-body">
                  <div class="tab-content">
					...
					<?php echo form_open_multipart('admin/stockphile/Barang_keluar/upload_image');?>
					<div class="row">	
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate form-control" name="surat_jalan" type="text" placeholder="Upload one files" required="required">
                                </div>
                            </div>
                            </div>
                        </div>
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row">	
						<div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <input class='form-control datepicker' type='text' name="tanggal_keluar" placeholder='Tanggal Pengiriman' required='required'>
						</div>	
					</div>
					<hr>
                    <br><br>
...
<script type="text/javascript">
 $(document).ready(function(){
  $('#po').change(function(){
   ...
   if(po != ''){
    $.ajax({
     url: "<?php echo base_url(); ?>admin/stockphile/barang_keluar/checkpo",
     method: "POST",
     data: {po:po},
