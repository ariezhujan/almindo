<?php
    class M_barang_keluar extends CI_Model{
        ...
        {
            $query = $this->db->get('barang_keluar_stock');
            return $query;
        }
		function tampil_gambar()
        {
            ...
            $query = $this->db->get_where('barang_keluar_stock',array('po' => $po, 'surat_jalan' => $surat_jalan));
            return $query;
        }
		public function getPo($po)
		 {	
		  $query = $this->db->get_where('barang_keluar_stock', array('po' => $po));
